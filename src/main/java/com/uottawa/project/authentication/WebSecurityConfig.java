...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		if(isDebug) {
			...
			.antMatchers("/relp_event_event/**").authenticated()
			.antMatchers("/relp_event_grant/**").authenticated()
			.antMatchers("/relp_event_member/**").authenticated()
			.antMatchers("/relp_event_partner/**").authenticated()
			.antMatchers("/relp_event_product/**").authenticated()
			.antMatchers("/relp_event_topic/**").authenticated()
			.antMatchers("/relp_grant_member/**").authenticated()
			.antMatchers("/relp_grant_member_investigator/**").authenticated()
			.antMatchers("/relp_grant_topic/**").authenticated()
			.antMatchers("/relp_member_affiliation/**").authenticated()
			.antMatchers("/relp_member_current_promotion/**").authenticated()
			...
			.antMatchers("/relp_partner_member/**").authenticated()
			.antMatchers("/relp_product_member/**").authenticated()
			.antMatchers("/relp_product_partner/**").authenticated()
			...
			.antMatchers("/types_affiliation/**").authenticated()
			.antMatchers("/types_event/**").authenticated()
			.antMatchers("/types_faculty/**").authenticated()
			.antMatchers("/types_frequency_indicator/**").authenticated()
			.antMatchers("/types_grant_source/**").authenticated()
			.antMatchers("/types_grant_status/**").authenticated()
			.antMatchers("/types_indicator_format/**").authenticated()
			.antMatchers("/types_member_cat/**").authenticated()
			.antMatchers("/types_partnership_scope/**").authenticated()
			.antMatchers("/types_partnership_type/**").authenticated()
			.antMatchers("/types_product/**").authenticated()
			.antMatchers("/types_promotion/**").authenticated()
